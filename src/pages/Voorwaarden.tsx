        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-[#FFFCEF]/90 text-lg leading-relaxed text-justify lg:text-left">
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF]">Artikel 1: Algemeen</h3>
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF]">Artikel 2: Totstandkoming van de overeenkomst</h3>
                <ol className="list-decimal list-inside space-y-2">
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF]">Artikel 3: Diensten en werkwijze</h3>
                <ol className="list-decimal list-inside space-y-2">
