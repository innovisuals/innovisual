        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-[#FFFCEF]/90 text-lg leading-relaxed text-justify lg:text-left">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 1: Algemeen</h3>
                <ol className="list-decimal space-y-2 mt-1">
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 2: Totstandkoming van de overeenkomst</h3>
                <ol className="list-decimal space-y-2 mt-1">
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 3: Diensten en werkwijze</h3>
                <ol className="list-decimal space-y-2 mt-1">
                ...
                <ol className="list-decimal space-y-2 mt-4" start={3}>
              ...
              <div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 4: Prijzen en betaling</h3>
  <ol className="list-decimal space-y-2 mt-1">
...
<div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 5: Intellectueel eigendom</h3>
  <ol className="list-decimal space-y-2 mt-1">
...
<div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 6: Gegevens en privacy</h3>
  <ol className="list-decimal space-y-2 mt-1">
...
<div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 7: Aansprakelijkheid</h3>
  <ol className="list-decimal space-y-2 mt-1">
...
<div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 8: Overtreding van voorwaarden en sancties</h3>
  <ol className="list-decimal space-y-2 mt-1">
  ...
  <ol className="list-decimal space-y-2 mt-4" start={2}>
...
<div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 9: Beëindiging en annulering</h3>
  <ol className="list-decimal space-y-2 mt-1">
...
<div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 10: Overmacht</h3>
  <ol className="list-decimal space-y-2 mt-1">
...
<div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 11: Toepasselijk recht en geschillen</h3>
  <ol className="list-decimal space-y-2 mt-1">
...
<div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 12: Wijziging van voorwaarden</h3>
  <ol className="list-decimal space-y-2 mt-1">
...
<div>
  <h3 className="text-2xl md:text-3xl font-bold text-[#FFFCEF] mb-2">Artikel 13: Slotbepalingen</h3>
  <ol className="list-decimal space-y-2 mt-1">
